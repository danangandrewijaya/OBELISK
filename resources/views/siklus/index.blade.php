                    ...
                    <tbody>
                        @forelse($siklus as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('siklus.show', $item) }}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i> Lihat
                                    </a>
                                    <a href="{{ route('siklus.configure', $item) }}" class="btn btn-sm btn-primary">
                                        <i class="fas fa-cog"></i> Konfigurasi
                                    </a>
                                    <a href="{{ route('siklus.edit', $item) }}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('siklus.destroy', $item) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
