<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('siklus2.edit', $siklus) }}
    @endsection
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('siklus2.update', $siklus) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-10">
                    ...
                    @if($siklus->siklusPis()->count() > 0)
                        <div class="form-text text-warning">
                            <i class="fas fa-exclamation-triangle"></i> Perubahan kurikulum akan mengharuskan konfigurasi ulang PI dan mata kuliah.
                        </div>
                    @endif
                </div>
