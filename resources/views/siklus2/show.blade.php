<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('siklus2.show', $siklus) }}
    @endsection
    ...
    <div class="card shadow-sm mb-5">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('siklus2.configure', $siklus) }}" class="btn btn-sm btn-primary me-2">
                    <i class="fas fa-cog"></i> Konfigurasi
                </a>
                <a href="{{ route('siklus2.edit', $siklus) }}" class="btn btn-sm btn-warning">
        ...
        <div class="card-body">
            ...
            <h3 class="mb-5">Rata-rata Ketercapaian PI</h3>
            ...
            @if(count($cplData) > 0)
                <div class="row">
                        ...
                        <div class="card card-flush h-100">
                            <div class="card-header pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Ringkasan PI</span>
                                </h3>
                            </div>
                                    ...
                                    @foreach($cplData as $cplId => $data)
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="flex-grow-1">
                                                <a href="#cpl-{{ $data['cpl']->nomor }}" class="text-gray-800 text-hover-primary fw-bold fs-6">PI {{ $data['cpl']->cpl->nomor.'-'.$data['cpl']->nomor }}</a>
                    ...
                    <div class="col-xl-8 mb-5">
                        <div class="card card-flush h-100">
                            <div class="card-header pt-5">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">Grafik Ketercapaian PI</span>
                                </h3>
                            </div>
                            <div class="card-body pt-0">
                ...
                @foreach($cplData as $cplId => $data)
                    <div class="card mb-5" id="cpl-{{ $data['cpl']->nomor }}">
                        <div class="card-header">
                            <h3 class="card-title">PI {{ $data['cpl']->cpl->nomor .'-'. $data['cpl']->nomor }}</h3>
                            <div class="card-toolbar">
                        ...
                        <div class="card-body">
                            <div class="mb-5">
                                <p class="text-gray-600">{!! nl2br(e('CPL '. $data['cpl']->cpl->nomor .' : '. $data['cpl']->cpl->nama)) !!}</p>
                            </div>
